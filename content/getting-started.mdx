...
Make sure you've got `Node` and optionally `Yarn`. Your `package.json` should contain following dependencies:
...
Our framework uses [Inter typeface](https://rsms.me/inter/) (Thank you @rsms for developing it!). To use the typeface simply require
it at the top of `App.js` (for Gatsby: `gatsby-browser.js` and `gatsby-ssr.js`).
